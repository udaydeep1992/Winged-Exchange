...
{
    utils.getJSON('https://wingedex.com/api/v1/public/getmarkets', (status, data) => {
        ...
        for (let i=0; i<data.result.length; i++)
        {
            ...
            utils.getJSON('https://wingedex.com/api/v1/public/getmarketsummary?market='+BTC+'-'+XHK+'&period=24', (status2, data2) => {
