...
exports.object = {
    ...
    '_words_' : {
        ...
        'New to Wingedex?' : ['New to Wingedex?', 'Еще не зарегистрированы на Wingedex?'],
        'Sign up now!' : ['Sign up now!', 'Зарегистрироваться сейчас!'],
        'Wingedex - Open Source Cryptocurrency Exchange' : ['Wingedex - Open Source Cryptocurrency Exchange', 'Wingedex - Биржа криптовалют с открытым кодом']
    }
};
