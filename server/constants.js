...
const SUPPORT_EMAIL = 'support@wingedex.com';
const NOREPLY_EMAIL = 'no-reply@wingedex.com';
const DOMAIN = 'app.wingedex.com';

const MAILER_NAME = 'Wingedex';
const START_MESSAGE = 'Wingedex Exchange started!';
const WINGEDEX = "WINGEDEX";

const EXCHANGE_NAME = "WINGEDEX";
...
exports.recaptcha_pub_key = "YOUR_RECAPTCHA_KEY";
...
exports.WINGEDEX = PRIVATE.WINGEDEX || WINGEDEX;
